...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-[#5f6fff] rounded-lg px-6 md:px-10 lg:px-20'>
        {/* -------Left-------- */}
        <div className='md:w-1/2 flex flex-col items] justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
            ...
            <div className='flex flex-col md:flex-row items-center justify-center gap-3 text-white text-sm font-light'>
                ...
                <p className='text-white'>Simply broswe through our extensive list of trusted doctors,<br className='hidden sm:block'/> schedule your appointment hassle-free</p>
            </div>
