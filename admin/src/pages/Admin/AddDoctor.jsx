      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            ...
            <div className='flex-1 flex flex-col gap-1'>
              <p>Experience</p>
              <select value={experience} onChange={(e)=> setExperience(e.target.value)} className='border rounded px-3 py-2' name="" id="experience">
          ...
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            <div className='flex-1 flex flex-col gap-1'>
              ...
              <p>Speciality</p>
              <select value={Speciality} onChange={(e)=>setSpeciality(e.target.value)} className='border rounded px-3 py-2' name="" id="speciality">
            ...
            <div className='flex-1 flex flex-col gap-1'>
              ...
              <input value={address2} onChange={(e)=>setAddress2(e.target.value)} className='border rounded px-3 py-2' type="text" placeholder='address1' required />
            </div>
        ...
        <div className='flex-1 flex flex-col gap-1'>
          ...
          <textarea value={about} onChange={(e)=>{setAbout(e.target.value)}} className='w-full px-4 border rounded' placeholder='Write about doctor' rows={5} />
        </div>
